...
function fulltabla() {
  ...
  if (chamber === "house") {
    ...
    congressP.textContent = 'Top 15 Congressmen "MISSED VOTES"';
    ...
    congressP.textContent = 'Top 15 Senators "MISSED VOTES"';
    document
      .querySelector("#congressInfo")
      .appendChild(congressH2)
      .appendChild(congressP);
  ...
  function generate_table() {
    ...
    jsonTablaState = jsonTablaState
      .sort((y, x) => x.missed_votes - y.missed_votes)
      .slice(0, 15);
